...
architecture STRUCTURE of bd_ff0d is
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN debug_run_processing_system7_0_1_FCLK_CLK0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
ila_lib: component bd_ff0d_ila_lib_0
     port map (
      ...
      probe3(0) => SLOT_0_GPIO_tri_o_1(0)
    );
end STRUCTURE;
