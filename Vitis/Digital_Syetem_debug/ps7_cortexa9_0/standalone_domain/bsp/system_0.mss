...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = LCD_AXI_GPIO
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = PMOD_Btn
END
...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = PWM_timer
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = RGB_LEDs
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = System_reset
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = tmrctr
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = System_Delay
END
